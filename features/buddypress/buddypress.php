...
/* 
//TOP: Not needed at all anymore.
A) wasn't completed
B) was moved to the new Feature mechanism 
Boone re-wrote some, but probably realized not necessary - just create the features and extend the Feature class and it works

//Register the feature
function ep_bp_register_feature() {
	
	//Original code from MESH
